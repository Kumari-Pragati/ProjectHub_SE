...
class TestAmaz2():
  ...
  def test_ajaydeepFilerProduct(self):
    self.driver.get("http://127.0.0.1:5500/jaideep/index.html")
    self.driver.set_window_size(1296, 688)
    self.driver.find_element(By.LINK_TEXT, "Filter Products").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#filters > .btn:nth-child(4)").click()
