...
exports.getStockMetaData = async (req, res) => {
  try {
    const url = `https://api.tiingo.com/tiingo/daily/${req.params.ticker}?token=49846d32f6356665b0efd3173bef151bbdbe54c3`;
...
exports.getStockHistoricData = async (req, res) => {
  try {
    ...
    const url = `https://api.tiingo.com/tiingo/daily/${req.params.ticker}/prices?startDate=${year}-${month}-${day}&token=49846d32f6356665b0efd3173bef151bbdbe54c3`;
...
exports.getRandomStockData = async (req, res) => {
  try {
    ...
    const url = `https://api.tiingo.com/tiingo/daily/${stock.ticker}/prices?startDate=${year}-${month}-${day}&token=49846d32f6356665b0efd3173bef151bbdbe54c3`;
